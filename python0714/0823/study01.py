...
# csv 모듈을 사용하지 않고 일반 텍스트 파일 사용하듯이 데이터를 가져오면 \n 문자 처리 및 각 데이터 구분을 위한 split() 작업이 추가로 필요함
for item in line:
    item = item[:-1]
